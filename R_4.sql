SELECT T1.`Year` AS Annee, T1.C1 AS `Moyenne des quantitées vendu chaque année hors Ægypte`,T2.C1 AS `Moyenne des quantitées vendu chaque année en Ægypte`, ROUND(T2.C1/T1.C1*100,2) AS `Difference en %`
FROM
(
